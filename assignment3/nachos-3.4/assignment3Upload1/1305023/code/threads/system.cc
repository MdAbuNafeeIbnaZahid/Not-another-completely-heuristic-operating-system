...
SynchDisk   *synchDisk;
    ...
    void consoleReadAvailable(int a){
        myConsole.readAvail->V();
    }
    void consoleWriteDone(int a){
        myConsole.writeDone->V();
    }
#endif
...
Initialize(int argc, char **argv)
{
    ...
    myConsole.readAvail = new Semaphore("sem read available", 0);
    myConsole.writeDone = new Semaphore("sem write done", 0);
#endif
...
Cleanup()
{
    ...
    delete myConsole.device;
    delete myConsole.readAvail;
    delete myConsole.writeDone;
    delete myConsole.lock;
#endif
